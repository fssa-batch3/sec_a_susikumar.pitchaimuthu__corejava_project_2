...
/**
 * This class contains constant messages related to still (possibly an image or
 * media content) validation, creation, update, deletion, and other
 * still-related operations.
 *
...
public class StillConstants {
    ...
    private static final String INVALID_STILL_FILTER_MESSAGE = "No still are found";
     ...
     *
     * @return The message indicating that the details for updating a still are not
     * valid.
     */
     ...
     *
     * @return The message indicating that the details for deleting a still are not
     * valid.
     */
     ...
     *
     * @return The message indicating that the details for reading a still are not
     * valid.
     */
    ...
    public static String getInvalidStillFilterMessage() {
        return INVALID_STILL_FILTER_MESSAGE;
    }
}
