...
/**
 * This class contains test cases for the UserService class, which handles various user-related operations.
 *
...
class TestUserService {
    ...
    void testRegistrationSuccess() {
        ...
        User user1 = new User("akalya@gmail.com", "Kani Papa", "susi123@SM", "Susikumar", "Pitchaimuthu",
    ...
    void testUserRegisterWithInvalidPassword() {
        ...
        UserService userService = new UserService();
        User user1 = new User("Susi@gmail.com", "Kani Papa", "susi123SM", "Susikumar", "Pitchaimuthu",
                "https://example.com/image.jpg");
        ServiceException result = assertThrows(ServiceException.class, () -> userService.registerUser(user1));
        String expectedMessage = UserConstants.getCommonServiceErrorMessage() + UserConstants.getInvalidUserPasswordMessage();
    ...
    void testLogInUserWithInvalidEmail() {
        ...
        ServiceException result = assertThrows(ServiceException.class, () -> userService.logInUser(user1));
        String expectedMessage = UserConstants.getCommonServiceErrorMessage() + UserConstants.getInvalidUserEmailMessage();
        assertEquals(expectedMessage, result.getMessage());
    }
    ...
    void testUpdateUserDetailsWithInvalidUserName() {
        ...
        ServiceException result = assertThrows(ServiceException.class, () -> userService.updateUser(user1, email));
        String expectedMessage = UserConstants.getCommonServiceErrorMessage() + UserConstants.getInvalidUserUserNameMessage();
        assertEquals(expectedMessage, result.getMessage());
    }
    ...
    void testUpdateUserDetailsWithInvalidGenderDetails() {
        ...
        ServiceException result = assertThrows(ServiceException.class, () -> userService.updateUser(user1, email));
        String expectedMessage = UserConstants.getCommonServiceErrorMessage() + UserConstants.getInvalidUserGenderMessage();
        assertEquals(expectedMessage, result.getMessage());
    }
    ...
    void testUpdateUserDetailsWithInvalidNationalityDetails() {
        ...
        User email = new User("susi@gmail.com");
        ServiceException result = assertThrows(ServiceException.class, () -> userService.updateUser(user1, email));
        String expectedMessage = UserConstants.getCommonServiceErrorMessage() + UserConstants.getInvalidUserNationalityMessage();
        assertEquals(expectedMessage, result.getMessage());
    }
    ...
    void testUpdateUserDetailsWithInvalidFirstNameDetails() {
        ...
        User email = new User("susi@gmail.com");
        ServiceException result = assertThrows(ServiceException.class, () -> userService.updateUser(user1, email));
        String expectedMessage = UserConstants.getCommonServiceErrorMessage() + UserConstants.getInvalidUserFirstNameMessage();
        assertEquals(expectedMessage, result.getMessage());
    }
